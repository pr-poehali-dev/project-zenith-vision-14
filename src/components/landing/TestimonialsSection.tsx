...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "Провели квест для всего класса — дети были в восторге! Никто не сидел со скучным видом, все носились и решали задания. Вовлечённость на максимуме.",
      name: "Анна Петрова",
      company: "Учитель, школа №42",
      image:
    ...
    {
      quote:
        "Использовали QR-квест на корпоративном тренинге. Коллеги познакомились и запомнили материал намного лучше, чем на обычных лекциях.",
      name: "Сергей Иванов",
      company: "HR-директор, DataFlow",
      image:
    ...
    {
      quote:
        "Создала экскурсию по музею в виде квеста. Посетители проводят в 2 раза больше времени и уходят с реальными знаниями, а не просто фотографиями.",
      name: "Мария Козлова",
      company: "Методист, городской музей",
      image:
